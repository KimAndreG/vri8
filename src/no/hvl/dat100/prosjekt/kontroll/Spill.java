...
public class Spill {
	...
	public Kort trekkFraBunke(ISpiller spiller) {
		...
		Kort nyttKort = bord.taOversteFraBunke();
		spiller.trekker(nyttKort);
	...
	public boolean leggnedKort(ISpiller spiller, Kort kort) {
		...
		boolean har = spiller.getHand().har(kort);
	...
	public Kort utforHandling(ISpiller spiller, Handling handling) {
		...
		HandlingsType handlingType = handling.getType();
		if (handlingType == HandlingsType.FORBI) {
			forbiSpiller(spiller);
		} else if (handlingType == HandlingsType.LEGGNED) {
			kort = handling.getKort();
			leggnedKort(spiller, kort);
		} else if (handlingType == HandlingsType.TREKK) {
